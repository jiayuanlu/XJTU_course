...
plt.ylabel('Loss')
plt.ylim(0,1)
plt.savefig(dataset+'_loss_curve50.png')
plt.show()
...
plt.ylabel('Accuracy')
plt.ylim(0,1)
plt.savefig(dataset+'_accuracy_curve50.png')
plt.show()
...
model=torch.load(dataset+'_model_'+str(28)+'.pt')
history_test = computeTestSetAccuracy(model, loss_func)
torch.save(history_test, dataset+'_history_test.pt')
...
# plt.ylabel('Loss')
# plt.ylim(0,1)
# plt.savefig(dataset+'_loss_curve_test.png')
# plt.plot(history_test[:,1])
# plt.legend(['Test Accuracy'])
# plt.xlabel('Epoch Number')
# plt.ylabel('Accuracy')
# plt.ylim(0,1)
# plt.savefig(dataset+'_accuracy_curve_test.png')
# plt.show()
